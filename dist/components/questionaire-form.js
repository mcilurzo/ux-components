...
const QuestionaireForm$1 = /*@__PURE__*/ proxyCustomElement(class QuestionaireForm extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return questionaireFormCss; }
}, [1, "questionaire-form", {
    "currentStep": [32],
    "answerHistory": [32]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["questionaire-form"];
  components.forEach(tagName => { switch (tagName) {
    case "questionaire-form":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, QuestionaireForm$1);
      }
      break;
  } });
}

const QuestionaireForm = QuestionaireForm$1;
const defineCustomElement = defineCustomElement$1;

export { QuestionaireForm, defineCustomElement };

//# sourceMappingURL=questionaire-form.js.map