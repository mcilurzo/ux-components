import { r as registerInstance, h, g as getElement } from './index-0e59f192.js';
...
const ColorContrastChecker = class {
  ...
  render() {
    ...
    return (h("div", { class: "color-contrast-checker" }, h("div", { class: "foreground-color" }, h("sbb-form-field", { "error-space": "none", label: t.color1Label, size: "m", width: "default" }, h("select", { id: "color1", onInput: (e) => {
        this.color1 = e.target.value;
      } }, this.colorOptions.map((color) => (h("option", { value: color.value }, color.name, " (", color.value, ")"))))), h("div", { class: "color-box", style: { backgroundColor: this.color1 } })), h("div", { class: "background-color" }, h("sbb-form-field", { "error-space": "none", label: t.color2Label, size: "m", width: "default" }, h("select", { id: "color2", onInput: (e) => {
