...
const ColorContrastChecker = class {
  ...
  render() {
    ...
    return (h("div", { class: "color-contrast-checker" }, h("div", { class: "foreground-color" }, h("sbb-form-field", { "error-space": "none", size: "m" }, h("label", null, t.color1Label), h("sbb-select", { id: "color1", onInput: (e) => {
        this.color1 = e.target.value;
      } }, this.colorOptions.map((color) => (h("sbb-option", { value: color.value }, color.name, " (", color.value, ")"))))), h("div", { class: "color-box", style: { backgroundColor: this.color1 } })), h("div", { class: "background-color" }, h("sbb-form-field", { "error-space": "none", size: "m" }, h("label", null, t.color2Label), h("sbb-select", { id: "color2", onInput: (e) => {
