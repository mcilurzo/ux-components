...
const QuestionaireForm = class {
  ...
  render() {
    if (this.currentStep >= this.questions.length) {
      return (h("sbb-group", { color: "milk", padding: "l-l" }, h("div", { class: "summary" }, h("div", { class: "history" }, h("sbb-title", { level: "4" }, "Deine Antworten"), this.answerHistory.map((entry) => (h("div", { class: "question" }, h("sbb-title", { level: "6" }, entry.question), h("p", { class: "answer " + entry.answer }, this.getLocalizedAnswer(entry.answer)))))), h("div", { class: "recommendation" }, h("sbb-title", { level: "4" }, "Unsere Empfehlung"), h("p", null, this.getRecommendation()), h("sbb-button", { variant: "secondary", size: "m", onClick: () => this.reset() }, this.getLocale().reset)))));
    }
    return (h("sbb-group", { color: "milk", padding: "l-l" }, h("div", { class: "summary" }, h("div", { class: "history" }, h("sbb-title", { level: "4" }, "Deine Antworten"), this.answerHistory.map((entry) => (h("div", { class: "question" }, h("sbb-title", { level: "6" }, entry.question), h("p", { class: "answer " + entry.answer }, this.getLocalizedAnswer(entry.answer)))))), h("div", { class: "recommendation" }, h("sbb-title", { level: "4" }, "Unsere Fragen"), h("sbb-title", { class: "question", level: "6" }, this.questions[this.currentStep].question), h("sbb-button", { variant: "secondary", size: "m", class: "button-left", onClick: () => this.handleAnswer('no') }, this.getLocale().no), h("sbb-button", { variant: "secondary", size: "m", class: "button-right", onClick: () => this.handleAnswer('yes') }, this.getLocale().yes)))));
  }
};
