...
const questionaireFormCss = "sbb-title{margin-block-start:0}.summary{display:grid;width:100%;grid-template-columns:1fr 1fr;grid-template-rows:auto;gap:32px;grid-template-areas:\"recommendation history\"}.back{grid-area:back;text-align:right}.recommendation{grid-area:recommendation}.history{grid-area:history}.history .title-answer{width:100%;display:block;border-bottom:solid 1px var(--sbb-color-cloud-default)}.history .question{margin-top:12px;padding-bottom:12px;margin-bottom:12px;border-bottom:solid 1px var(--sbb-color-cloud-default)}.history .question sbb-title{margin-block-start:0}p{margin:0 0 var(--sbb-spacing-fixed-4x) 0}p.answer{margin-bottom:0}.button-left{margin-right:var(--sbb-spacing-fixed-4x)}";
...
const QuestionaireForm = class {
  ...
  render() {
    if (this.currentStep >= this.questions.length) {
      return (h("sbb-group", { color: "milk", padding: "l-l" }, h("div", { class: "summary" }, h("div", { class: "history" }, h("sbb-title", { class: "title-answer", level: "4" }, "Deine Antworten"), this.answerHistory.map((entry) => (h("div", { class: "question" }, h("sbb-title", { level: "6" }, entry.question), h("p", { class: "answer " + entry.answer }, this.getLocalizedAnswer(entry.answer)))))), h("div", { class: "recommendation" }, h("sbb-title", { level: "4" }, "Unsere Empfehlung"), h("p", null, this.getRecommendation()), h("sbb-button", { variant: "secondary", size: "m", onClick: () => this.reset() }, this.getLocale().reset)))));
    }
    return (h("sbb-group", { color: "milk", padding: "l-l" }, h("div", { class: "summary" }, h("div", { class: "history" }, h("sbb-title", { class: "title-answer", level: "4" }, "Deine Antworten"), this.answerHistory.map((entry) => (h("div", { class: "question" }, h("sbb-title", { level: "6" }, entry.question), h("p", { class: "answer " + entry.answer }, this.getLocalizedAnswer(entry.answer)))))), h("div", { class: "recommendation" }, h("sbb-title", { level: "4" }, "Unsere Fragen"), h("sbb-title", { class: "question", level: "6" }, this.questions[this.currentStep].question), h("sbb-button", { variant: "secondary", size: "m", class: "button-left", onClick: () => this.handleAnswer('no') }, this.getLocale().no), h("sbb-button", { variant: "secondary", size: "m", class: "button-right", onClick: () => this.handleAnswer('yes') }, this.getLocale().yes)))));
  }
};
